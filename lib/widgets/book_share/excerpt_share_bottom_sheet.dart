...
import 'package:cubebook/providers/font_list.dart';
...
import 'package:cubebook/widgets/book_share/excerpt_share_card.dart';
import 'package:cubebook/widgets/icon_and_text.dart';
import 'package:cubebook/widgets/show_loading.dart';
...
class _ExcerptShareBottomSheetState
  ...
  Future<void> _saveAsImage() async {
    ...
    final fileName = 'Cubebook_${widget.bookTitle.replaceAll(' ', '_')}';
